...
m_eq=delta*Mv;
Gr=1; %fixed gear ratio
fr=0.006; %rolling resistyance constant
Cd=0.35; %Aerodynamics drag
Af=2.5; %frontal area
r=.249;%(15*0.0254+(2*0.155*0.6))/2; % tire size 155/60R15
nu=0.9*.9*.85; %efficiency
