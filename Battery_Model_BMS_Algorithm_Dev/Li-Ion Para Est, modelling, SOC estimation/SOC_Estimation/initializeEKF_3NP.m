...
% 2015.
function ekfData = initializeEKF_3NP(v0,T0,SigmaX0,SigmaV,SigmaW,model,numpoles)
...
% ir3   = 0;
  x0= zeros(1,numpoles);
  ekfData.irInd1 = 1:numpoles;
% ekfData.irInd2 = 2;
% ekfData.irInd3 = 3;
  ekfData.hkInd = numpoles+1;
  ekfData.zkInd = numpoles+2;
  ekfData.xhat  = [x0 hk0 SOC0]'; % initial state
